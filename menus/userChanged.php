...
<head>
    ...
    <title>Usuário Editado | Fando</title>
...
<body>
    <form action="../index.php">
        ...
        <h2><b>Conta editada!</b></h2>
        <h6 class="form-text text-muted">Redirecionando em alguns segundos...</h6>
        <meta http-equiv="refresh" content="2;URL='../menus/homeScreen.php'">
